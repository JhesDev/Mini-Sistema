...
('INM-2026-0002', 2, NULL, 'Hyundai', 'Accent', 2020, 'EN_FIRMAS', 180.50),
('INM-2026-0003', 3, 'XYZ-789', 'Kia', 'Sportage', 2023, 'PRESENTADO', 350.00),
('INM-2026-0004', 4, 'MNO-456', 'Nissan', 'Sentra', 2019, 'CERRADO', 420.00),
('INM-2026-0005', 1, 'PQR-101', 'Toyota', 'Yaris', 2021, 'EN_FIRMAS', 220.00),
('INM-2026-0006', 2, NULL, 'Kia', 'Rio', 2020, 'REGISTRADO', 175.50),

('INM-2026-0007', 3, 'LMN-234', 'Hyundai', 'Tucson', 2022, 'PRESENTADO', 310.00),
('INM-2026-0008', 4, 'BCD-345', 'Nissan', 'Versa', 2019, 'ANULADO', 200.00),
('INM-2026-0009', 1, 'EFG-456', 'Chevrolet', 'Onix', 2023, 'CERRADO', 450.00),
('INM-2026-0010', 2, 'HIJ-567', 'Toyota', 'Corolla', 2020, 'PRESENTADO', 280.00),

('INM-2026-0011', 3, NULL, 'Mazda', 'CX-5', 2021, 'REGISTRADO', 195.00),
('INM-2026-0012', 4, 'KLM-789', 'Ford', 'Ranger', 2022, 'EN_FIRMAS', 325.00),
('INM-2026-0013', 1, 'NOP-890', 'Honda', 'Civic', 2018, 'OBSERVADO', 240.00),
('INM-2026-0014', 2, 'QRS-901', 'Suzuki', 'Swift', 2021, 'PRESENTADO', 275.00),
('INM-2026-0015', 3, 'TUV-012', 'Volkswagen', 'Gol', 2019, 'CERRADO', 390.00),
('INM-2026-0016', 4, NULL, 'Renault', 'Duster', 2023, 'REGISTRADO', 185.00),

('INM-2026-0017', 1, 'ABC-201', 'Toyota', 'RAV4', 2022, 'EN_FIRMAS', 350.00),
('INM-2026-0018', 2, 'DEF-312', 'Hyundai', 'Elantra', 2020, 'PRESENTADO', 290.00),
('INM-2026-0019', 3, NULL, 'Kia', 'Seltos', 2023, 'REGISTRADO', 210.00),
('INM-2026-0020', 4, 'GHI-423', 'Nissan', 'Kicks', 2021, 'CERRADO', 480.00),
('INM-2026-0021', 1, 'JKL-534', 'Mitsubishi', 'Outlander', 2019, 'ANULADO', 260.00),
('INM-2026-0022', 2, 'MNO-645', 'Toyota', 'Hilux', 2022, 'PRESENTADO', 375.00),

('INM-2026-0023', 3, 'PQR-756', 'Ford', 'EcoSport', 2020, 'EN_FIRMAS', 225.00),
('INM-2026-0024', 4, NULL, 'Chevrolet', 'Tracker', 2023, 'REGISTRADO', 190.00),
('INM-2026-0025', 1, 'STU-867', 'Honda', 'HR-V', 2021, 'PRESENTADO', 315.00),
('INM-2026-0026', 2, 'VWX-978', 'Mazda', 'Mazda 3', 2020, 'OBSERVADO', 245.00),
('INM-2026-0027', 3, 'YZA-089', 'Suzuki', 'Vitara', 2018, 'CERRADO', 410.00),
('INM-2026-0028', 4, 'BCD-190', 'Volkswagen', 'T-Cross', 2022, 'EN_FIRMAS', 330.00),

('INM-2026-0029', 1, NULL, 'Nissan', 'X-Trail', 2021, 'REGISTRADO', 180.00),
('INM-2026-0030', 2, 'EFG-301', 'Toyota', 'Fortuner', 2023, 'PRESENTADO', 520.00),
('INM-2026-0031', 3, 'HIJ-412', 'Kia', 'Sportage', 2022, 'CERRADO', 460.00),
('INM-2026-0032', 4, 'KLM-523', 'Hyundai', 'Santa Fe', 2020, 'OBSERVADO', 285.00),
('INM-2026-0033', 1, 'NOP-634', 'Renault', 'Kwid', 2019, 'ANULADO', 160.00),
('INM-2026-0034', 2, NULL, 'Chevrolet', 'Tracker', 2022, 'REGISTRADO', 205.00),

('INM-2026-0035', 3, 'QRS-745', 'Ford', 'Escape', 2021, 'EN_FIRMAS', 295.00),
('INM-2026-0036', 4, 'TUV-856', 'Toyota', 'Camry', 2019, 'PRESENTADO', 340.00),
('INM-2026-0037', 1, 'VWX-967', 'Honda', 'CR-V', 2023, 'CERRADO', 490.00),
('INM-2026-0038', 2, 'YZA-178', 'Mazda', 'CX-30', 2022, 'EN_FIRMAS', 275.00),
('INM-2026-0039', 3, NULL, 'Kia', 'Picanto', 2020, 'REGISTRADO', 150.00),
('INM-2026-0040', 4, 'BCD-289', 'Nissan', 'Sentra', 2021, 'PRESENTADO', 310.00),

('INM-2026-0041', 1, 'EFG-390', 'Volkswagen', 'Tiguan', 2022, 'OBSERVADO', 295.00),
('INM-2026-0042', 2, 'HIJ-401', 'Toyota', 'Avanza', 2019, 'CERRADO', 380.00),
('INM-2026-0043', 3, 'KLM-512', 'Hyundai', 'Creta', 2023, 'PRESENTADO', 325.00),
('INM-2026-0044', 4, NULL, 'Suzuki', 'Jimny', 2021, 'REGISTRADO', 170.00),
('INM-2026-0045', 1, 'NOP-623', 'Mitsubishi', 'ASX', 2020, 'EN_FIRMAS', 255.00),
('INM-2026-0046', 2, 'PQR-734', 'Ford', 'Ranger', 2022, 'PRESENTADO', 415.00),

('INM-2026-0047', 3, 'STU-845', 'Chevrolet', 'Sail', 2018, 'CERRADO', 360.00),
('INM-2026-0048', 4, 'VWX-956', 'Renault', 'Captur', 2021, 'OBSERVADO', 235.00),
('INM-2026-0049', 1, NULL, 'Kia', 'Carens', 2022, 'REGISTRADO', 190.00),
('INM-2026-0050', 2, 'YZA-067', 'Toyota', 'Hilux', 2023, 'EN_FIRMAS', 375.00);
